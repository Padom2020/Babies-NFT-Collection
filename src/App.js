...
import i1 from "./assets/images/Icon.png";
...
function App() {
  ...
  const claimNFTs = (_amount) => {
    ...
    setFeedback("Minting your Baby NFT Wait a sec...");
    setClaimingNft(true);
    blockchain.smartContract.methods
      ...
      .then((receipt) => {
        setFeedback(
          "WOW, you now own a Baby NFT. go visit Opensea.io to view it."
        );
        setClaimingNft(false);
  ...
  return (
    <s.Screen style={{ backgroundColor: "var(--lemon)" }}>
      <s.Container flex={1} ai={"center"} style={{ padding: 24 }}>
            ...
            {Number(data.totalSupply) == 10000 ? (
              <>
                ...
                <s.TextDescription style={{ textAlign: "center" }}>
                  You can still find Babies World NFT on{" "}
                  <a
                    target={"_blank"}
                    href={"https://testnets.opensea.io/collection/babies-world-nft-collection"}
                  >
                    Opensea.io
                  </a>
                </s.TextDescription>
              ...
              <>
                <s.TextTitle style={{ textAlign: "center" }}>
                  1 Baby will costs you 0.04 Ether.
                </s.TextTitle>
                <s.SpacerXSmall />
                <s.TextDescription style={{ textAlign: "center" }}>
                  Excluding gas fee.
        ...
        <s.Container jc={"center"} ai={"center"} style={{ width: "70%" }}>
          <s.TextDescription style={{ textAlign: "center", fontSize: 9 }}>
            Please make sure you are connected to the right network (Etheruem
